...
async function predict(image) {
    ...
    const percentage = (performance.now()/1000);
    status(`Artificial Ripening is  ${Math.floor(percentage)}%. \n Estimated in ${Math.floor(totalTime)}ms.`);
...
async function showResult(logits) {
    const message = {
        0: 'This banana looks like artificially ripened! Wait a little longer before eating it.',
        1: 'This banana is natural.',
        2: 'This banana is natural!'
    }
